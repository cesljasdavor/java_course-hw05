...
public class ObjectMultistack {
	 ...
	 * 
	 * @throws IllegalArgumentException
	 *             ukoliko je stog prazan ili ukoliko je ključ <code>null</code>
	 *             ili takav ključ ne postoji u internoj strukturi
	 */
	...
	private void checkIfStackEmpty(MultistackEntry firstNode, String name) {
		if (firstNode == null) {
			throw new IllegalArgumentException(String.format("Stog za ključ '%s' je prazna", name));
		}
	}
